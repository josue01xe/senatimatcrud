    ...
    if ($data){
      ...
      foreach($data as $registro){
        ...
        if ($registro['fotografia'] == ''){
          ...
          echo " <a href='../views/img/fotografias/{$registro['fotografia']}' data-lightbox='{$registro['idcolaborador']}' data-title='{$datosColaborador}' class='btn btn-sm btn-warning'><i class='bi bi-eye-fill'></i></a>";
        }
